...
const features = [
  {
    title: "Manage Books",
    description:
      "Librarians can create and delete books within various sections of the library.",
  ...
  },
  {
    ...
    description:
      "Librarians can handle the issuing and returning process of books for users.",
